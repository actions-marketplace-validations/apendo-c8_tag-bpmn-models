...
const getFileIdsByProjectId = (token) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield axios_1.default.post(urlMilestone, body, {
            headers: {
...
const setMilestone = (token, fileId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const runWorkflow = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const token = yield getToken();
        const fileIds = yield getFileIdsByProjectId(token);
        for (const file of fileIds) {
            yield setMilestone(token, file);
        }
    }
    catch (error) {
        (0, core_1.setFailed)(error instanceof Error ? error.message : 'An error occurred');
